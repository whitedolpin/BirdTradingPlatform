...
public class DispatcherServlet extends HttpServlet {
    ...
    private String BlockAccController = "BlockAccController";
    private String CreateNewAccountSuggest = "CreateNewAccountSuggest";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = "Err.html";
        //http://localhost:8080/BirdPlatformHello/product?productID=${requestScope.productdetail.getProductID()}&action=detail
        
        try {
            String submit = request.getParameter("MAIN");
            if (submit == null) {
                url = "ProductErrPage.jsp";
            ...
            }else if(submit.equalsIgnoreCase("Block Account")){
                url = BlockAccController;
            }
            else if(submit.equalsIgnoreCase("Suggest request")){
                url = CreateNewAccountSuggest;
            }
