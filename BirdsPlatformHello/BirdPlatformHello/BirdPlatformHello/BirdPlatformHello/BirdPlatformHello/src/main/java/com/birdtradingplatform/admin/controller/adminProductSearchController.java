 ...
 * @author Minh Quan
 */
@WebServlet(name = "adminProductSearchController", urlPatterns = {"/adminProductSearchController"})
     ...
     */
     protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            java.util.List<Product> products = productDAO.getProductByName(txtSearch);
