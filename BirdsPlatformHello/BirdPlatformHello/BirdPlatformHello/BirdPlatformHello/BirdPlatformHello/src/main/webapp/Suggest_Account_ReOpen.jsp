            ...
            <header class="header">
                ...
                <main class="main-container">
                    <div class="col-md-10 col-sm-12" id="main" style="padding: 3%; width: 100%">
                        <h3 style=" margin-bottom: 2%; color: #000">ReOpen accounts management</h3>
                        <div class="container product-box">
                            ...
                            <div class="row">
                                ...
                                <div class="col-10">
                                    <form id="product-search" action="adminAccountSearchController" method="post" >
                                        <input type="search" name="txtSearch" id="search" placeholder="Search Account" value="${txtSearch}"/>
                                    <input type="hidden" name="urlLink" value="Suggest_Account_ReOpen.jsp"> 
                                    <button type="submit">
                                        Search
                                    </button>
                                </form>
                            ...
                            <div class="row">
                                <div class="col"></div>
                                <div class="col-10">
                                <c:if test="${ not empty requestScope.DeclineStatus}">
                                    <h4 style="color: red"> Decline Account successfully</h4>
                                </c:if>
                                    
                                <c:if test="${ not empty requestScope.ReOpenStatus}">
                                    <h4 style="color: red"> ReOpen  Account successfully</h4>
                                </c:if>    
                            </div>
                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center" scope="col">Why is Blocked</th>
                                            <th class="text-center" scope="col">Why to Open</th>
                                    ...
                                    <tbody>
                                        ...
                                        <c:if test="${not empty userList}">
                                            ...
                                            <form action="AdminReOpenAccount" method="POST">
                                                ...
                                                <tr  >
                                                    ...
                                                    <td class="text-left" >${user.regisDate}</td>
                                            ...
                                            <td class="text-center"> 
                                                ...
                                                <form action="AdminReOpenAccount" method="get">
                                                    <input type="hidden" name="AccID" value="${user.accountID}"/>
                                                    <input type="hidden" name="DeclineAcc" value="${user.accountID}"/>
                                                    ...
                                                    <div class="AddFBform" id="detail${user.accountID}"> <!-- comment -->
                                                        <h2>
                                                            Do you want to Decline account ${user.username}  ?
                                                        </h2>
