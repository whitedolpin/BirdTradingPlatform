        ...
        <main>
                        ...
                        <form action="DispatcherServlet" autocomplete="off" class="sign-in-form" method="POST">
                            ...
                            <div class="heading">
                                ...
                                <c:if test="${ not empty requestScope.validAcc}">
                                    <h5 style="color:red;">Account is not valid</h5>
                                </c:if>
                                    
                                <c:if test="${ not empty requestScope.ChangePassOK}">
                                    <h5 style="color:blue;">Change pass successfully!!!</h5>
                                </c:if>
                                    
                                <c:if test="${ not empty requestScope.DELETED}">
                                    <h5 style="color: red;">Your account is blocked!!!</h5>
                                    <a href="Customer_Suggest_ReOpen_Account.jsp">
                                        Get help?
                                    </a>
                                </c:if>
                            </div>
                            ...
                            <div class="actual-form">
                                ...
                                <a href="https://accounts.google.com/o/oauth2/auth?scope=email&redirect_uri=http://localhost:8080/BirdPlatformHello/LoginGoogleHandler&response_type=code
		   &client_id=1037707091680-1aq2v2s9f844d1qs4dapbn521vdi89pe.apps.googleusercontent.com&approval_prompt=force" class="gg-btn">
                <span class="btn-text">Google</span>
                                ...
                                <p class="text">
                                    Forgotten your password or login failed !
                                    <a href="Checkmail.jsp">Get help</a> now.
                                </p>
                            </div>
                        </form>
                    </div>
