                                ...
                                <c:if test="${not empty orderDetailsList}">
                                    ...
                                    <form action="shopOrderDetailsController" method="POST">
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <c:forEach var="price" items="${priceMap}">
                                                    <c:if test="${price.key eq orderDetail.productID}">
                                                        ${price.value}
                                                    </c:if>
                                                </c:forEach>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <c:forEach var="amount" items="${priceMap}">
                                                    <c:if test="${amount.key eq orderDetail.productID}">
                                                        <c:set var="total" value="${amount.value * orderDetail.quantity}" />
                                                        ${total}
                                                    </c:if>
                                                </c:forEach>
                                            </td>
                    ...
                    <div class="total-all">
                        <div class="text-wrap">
                            ...
                            <div class="text">
                                ...
                                <span class="all-pay">$${total + 5}</span>
                            </div>
                        </div>
                            <div class="ShopOrderDetail_button" >
                               
                                    <form action="shopSaveOrderController" method="POST"> 
                                    <input type="hidden" name="orderID" value="${requestScope.orderID}">
                                    <input class="ButtonNe" type="submit" name="status" value="Cancel">
                                </form>
                                
                                
                                    
                                        <a class="ButtonNe" href="shopOrdersController" > Go back </a>
