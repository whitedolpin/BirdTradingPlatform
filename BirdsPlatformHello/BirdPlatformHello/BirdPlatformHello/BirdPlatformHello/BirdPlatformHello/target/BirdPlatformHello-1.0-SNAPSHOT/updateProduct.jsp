  ...
  <body>
	...
	<div class="user__details">
		<div class="input__box">
		  <span class="details">Product name</span>
                  <input name="productname" type="text" placeholder="" value="${dto.productName}"  >
		</div>
    ...
    <div class="input__box">
		  <span class="details"> Species  </span>
                  <input value="${dto.type}" name="type" type="text" placeholder=""  >
		</div>

    <div class="input__box">
		  <span class="details"> Quantity  </span>
                  <input value="${dto.quantity}" name="quantity" type="number" placeholder="" min="0"  >
		</div>
	      </div>
     ...
     <section class="userInfo">
      ...
      <div class="user__details">
        <div class="input__box">
          ...
          <input value="${dto.description}" name="description" type="text" placeholder=""  >
        </div>
      
        <div class="input__box">
          <span class="details">Price</span>
          <input value="${dto.priceIn}" name="price" type="text" placeholder="" min="0"  >
        </div>
            </div>
        </section>
     ...
     <section class="userInfo">
      ...
      <div class="user__details">
        ...
        <div class="input__box">
          ...
          <input value="${dto.pSale}" type="text" placeholder="" pattern="[0-9]{1,2}(\.[0-9]{1,2})?%?" title="Enter a value between 0 and 1"  >
